...
public class Utility {
    ...
    public static void drawPolygon(Graphics g, Vector2D[] polygon) {
        Vector2D P;
        Vector2D S = polygon[polygon.length - 1];
    ...
    public static void drawPolygon(Graphics g, List<Vector2D> polygon) {
        Vector2D S = polygon.get(polygon.size() - 1);
    ...
    public static void fillPolygon(Graphics2D g, Vector2D[] polygon) {
    ...
    public static void fillPolygon(Graphics2D g, List<Vector2D> polygon) {
        Polygon p = new Polygon();
        for (Vector2D v : polygon) {
            p.addPoint((int) v.x, (int) v.y);
        }
