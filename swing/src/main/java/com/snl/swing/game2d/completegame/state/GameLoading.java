...
import com.snl.swing.game2d.completegame.admin.*;
import com.snl.swing.game2d.completegame.object.AsteroidFactory;
import com.snl.swing.game2d.completegame.object.PolygonWrapper;
import com.snl.swing.game2d.completegame.object.ShipFactory;
import com.snl.swing.game2d.sound.BlockingClip;
import com.snl.swing.game2d.sound.BlockingDataLine;
import com.snl.swing.game2d.sound.LoopEvent;
...
public class GameLoading extends State {
    ...
    private byte[] loadSound(String path) {
        InputStream in = ResourceLoader.load(GameLoading.class,
                "./file/sound/" + path, "./file/sound/" + path);
        return readBytes(in);
    }
