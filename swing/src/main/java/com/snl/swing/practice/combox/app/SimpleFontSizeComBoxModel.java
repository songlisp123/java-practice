...
import com.snl.swing.practice.combox.model.FontSizeComboxModel;
...
public class SimpleFontSizeComBoxModel<T extends JTextComponent> extends JComboBox<String>
        implements ItemListener, CaretListener , ListDataListener
{
    protected T t;
    protected int start;
    protected int end;
    protected FontSizeComboxModel model;

    public SimpleFontSizeComBoxModel() {
        model = new FontSizeComboxModel();
