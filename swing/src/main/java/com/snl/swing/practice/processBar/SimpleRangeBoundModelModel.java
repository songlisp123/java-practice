...
public class SimpleRangeBoundModelModel implements BoundedRangeModel {
    ...
    public SimpleRangeBoundModelModel() {
        extent = 0;
        this.min = 0;
        this.max = this.min + DEFAULT_STEP;
    }

    public SimpleRangeBoundModelModel(int min, int max) {
        this.min = min;
        this.max = max;
    }

    public SimpleRangeBoundModelModel(int min) {
        this.min = min;
