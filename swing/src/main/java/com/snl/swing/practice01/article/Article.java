package com.snl.swing.practice01.article;

import com.snl.swing.practice01.entity.Sprite;
import com.snl.swing.practice01.entity.booms.BoomShape;
...
public abstract class Article extends Sprite {
    ...
    public Article(double xPos, double yPos, int WEIGHT, int HEIGHT, Color color) {
        this(xPos,yPos,WEIGHT,HEIGHT,color,BoomShape.CIRCLE);
    }

    public Article(double xPos, double yPos, int WEIGHT, int HEIGHT, BoomShape shape) {
        this(xPos,yPos,WEIGHT,HEIGHT,Color.magenta,shape);
    }

    public Article(double xPos, double yPos, int WEIGHT, int HEIGHT,
                   Color color, BoomShape shape) {
    ...
    private void initData() {
        ...
        //初始化y轴速度
        ySpeed = generator.nextDouble(-MAX_YSPEED,MAX_YSPEED);
