...
public class GameSlide {
    ...
    public GameSlide(double w, double h, Point2D leftC0Pos) {
        this.w = w;
        this.h = h;
    ...
    public GameSlide(double x,double y,double w,double h) {
    ...
    public GameSlide(double x,double y,double w,double h,double total) {
        leftC0Pos = new Point2D.Double(x + h / 2.0,y + h / 2.0);
        this.w = w;
        this.h = h;
        r0 = 2 * h;
