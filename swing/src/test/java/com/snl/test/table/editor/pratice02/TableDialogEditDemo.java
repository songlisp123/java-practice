...
import com.snl.test.table.editor.pratice01.ColorEditor;
import com.snl.test.table.editor.pratice01.ColorRenderer;
...
public class TableDialogEditDemo extends JPanel  {
    ...
    protected SimpleTableCellRenderer renderer;
...
//        table.setDefaultRenderer(String.class,renderer);
        table.getColumn("First Name").setCellRenderer(renderer);
